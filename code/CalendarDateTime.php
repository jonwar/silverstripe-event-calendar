...
//			new CheckboxField('AllDay', _t('CalendarDateTime.ALLDAY','This event lasts all day'))
			new DateField('StartDate',_t(CalendarDateTime::class.'.STARTDATE','Start date')),
			new DateField('EndDate',_t(CalendarDateTime::class.'.ENDDATE','End date')),
			new TimeField('StartTime', _t(CalendarDateTime::class.'.STARTTIME','Start time')),
			new TimeField('EndTime', _t(CalendarDateTime::class.'.ENDTIME','End time')),
			new CheckboxField('AllDay', _t(CalendarDateTime::class.'.ALLDAY','This event lasts all day'))
		);
...
//		$ics_start = $this->obj('StartDate')->Format('Ymd')."T".$this->obj('StartTime')->Format('His');
		$ics_start = $this->obj('StartDate')->Format('yyyyMMdd')."T".$this->obj('StartTime')->Format('HHmmss');
		if($this->EndDate) {
//			$ics_end = $this->obj('EndDate')->Format('Ymd')."T".$this->obj('EndTime')->Format('His');
			$ics_end = $this->obj('EndDate')->Format('yyyyMMdd')."T".$this->obj('EndTime')->Format('HHmmss');
		}
		else {
			$ics_end = $ics_start;
		}
...
//	   return CalendarUtil::get_date_format() == "mdy" ? $this->obj('StartDate')->Format('m-d-Y') : $this->obj('StartDate')->Format('d-m-Y');
	   return CalendarUtil::get_date_format() == "mdy" ? $this->obj('StartDate')->Format('MM-dd-yyyy') : $this->obj('StartDate')->Format('dd-MM-yyyy');
	}

	public function getFormattedEndDate() {
	   if(!$this->EndDate) return "--";
//	   return CalendarUtil::get_date_format() == "mdy" ? $this->obj('EndDate')->Format('m-d-Y') : $this->obj('EndDate')->Format('d-m-Y');
	   return CalendarUtil::get_date_format() == "mdy" ? $this->obj('EndDate')->Format('MM-dd-yyyy') : $this->obj('EndDate')->Format('dd-MM-yyyy');
	}
